        ...
        <Dialog>
            <DialogTrigger asChild>
                 <div className="absolute top-24 right-4 z-20">
                     <Button className="relative rounded-full h-16 w-16 bg-red-500/80 hover:bg-red-500 shadow-lg shadow-red-500/30 animate-pulse">
                         <AiBrainIcon className="h-9 w-9 text-white" />
                         <span className="sr-only">Show Marco AI Announcement</span>
                    </Button>
                </div>
            </DialogTrigger>
            <DialogContent className="bg-transparent border-0 shadow-none p-0 max-w-2xl">
                    ...
                    <div className="relative z-10 p-6">
                        <CardContent className="relative z-10 p-6 flex flex-col md:flex-row items-center text-center md:text-left gap-6 rounded-lg bg-black/20 border border-white/10">
                            <div className="flex-1">
                                ...
                                <CardTitle className="text-3xl lg:text-4xl font-bold mt-1 text-white">Marco AI 👑🔥</CardTitle>
                         ...
                         {isSignedIn && (
                            <div className="relative z-10 p-4 bg-amber-500/10 border-t border-amber-500/20 text-center text-amber-300 text-sm font-semibold flex items-center justify-center gap-2 mt-4 rounded-b-lg">
