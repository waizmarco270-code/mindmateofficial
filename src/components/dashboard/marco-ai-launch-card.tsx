                    ...
                    <AccordionTrigger className="p-6 text-left hover:no-underline [&[data-state=open]>svg]:-rotate-180">
                         <div className="flex flex-col sm:flex-row items-center gap-6 w-full">
                            ...
                            <div className="flex-1 text-center sm:text-left">
                                <h2 className="text-2xl font-bold">A Legendary Announcement Awaits...</h2>
                                <p className="text-muted-foreground mt-1">Click to reveal the next chapter of MindMate.</p>
                            </div>
                             <ChevronDown className="h-8 w-8 text-muted-foreground transition-transform duration-300 shrink-0" />
                        </div>
                    </AccordionTrigger>
                    <AccordionContent>
