...
import { Plus, Edit, Trash2, ArrowLeft, ArrowRight, ArrowLeftRight, BrainCircuit } from 'lucide-react';
                ...
                <div className="flex justify-end mb-4">
                 ...
                 {deck.cards.length > 0 ? (
                    <div className="space-y-3">
                     ...
                     <div className="text-center py-16 border-2 border-dashed rounded-lg">
                        <p className="text-muted-foreground">This deck is empty. Add a card to get started!</p>
                    </div>
                 )}
            </CardContent>
