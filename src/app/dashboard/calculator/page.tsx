...
export default function PercentageCalculatorPage() {
  ...
  useEffect(() => {
    ...
    setResult(null); // Reset result when template changes
  }, [template]);
        ...
        <Card className="lg:col-span-2">
            <CardHeader>
                <CardTitle>Enter Your Marks</CardTitle>
                 <Tabs value={template} onValueChange={(v) => setTemplate(v as TemplateType)} className="w-full pt-2">
             ...
             <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                        -{CALCULATION_COST} credits per calculation
                    </p>
                </CardContent>
            </Card>
        </div>
