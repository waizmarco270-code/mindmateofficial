...
import { useAdmin, type Resource, type DailySurprise, type ResourceSection, type SupportTicket, type FeatureShowcase, type ShowcaseTemplate, type VideoCategory, type VideoLecture } from '@/hooks/use-admin';
...
import { PlusCircle, Send, Trash2, MinusCircle, Vote, AlertTriangle, Edit, Lock, Unlock, Gift, RefreshCcw, Users, Megaphone, BookOpen, ClipboardCheck, KeyRound, ShieldCheck, UserCog, DollarSign, Wallet, ShieldX, Lightbulb, Image as ImageIcon, Mic, MessageSquare, FolderPlus, Sparkles, Loader2, Gamepad, Award, Zap, Gamepad2 as Gamepad2Icon, BrainCircuit, Trophy, BookOpen as BookOpenIcon, Clock, LineChart, Upload, History, MailQuestion, CheckCircle, Star, Swords, UserPlus, XCircle, Film } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      <Accordion type="multiple" defaultValue={['content-management']} className="w-full space-y-4">
        ...
        {/* Study Panel */}
        <AccordionItem value="study-panel" className="border-b-0">
          <Card>
            <AccordionTrigger className="p-6">
               <div className="flex items-center gap-3">
                <Film className="h-6 w-6 text-primary" />
                <div>
                  <h3 className="text-lg font-semibold">Study Panel</h3>
                  <p className="text-sm text-muted-foreground text-left">Manage video lectures and categories.</p>
                </div>
              </div>
            </AccordionTrigger>
